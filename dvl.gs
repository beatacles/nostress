...
function getLists_DVL_() {
  var lists = [
    ...
    // Таблица с БД материалов
        {
      dict: "'material'!A2:K",
      dict_file: '1m0RQi8GefoIyN4XO9vo_DZQfhYdI12sIbuC0gJ3D6TI',
      first_row: 3,
...
function onOpen(e) {
  ...
  ui.createMenu('♟️ dvl')
      ...
      .addItem("Cоздать ИД","modal")
      .addItem("Создать сопроводительную документацию", "make_doc_folder")
      .addItem("Скачать все архивом", "g2pc")
      .addToUi();
  clearMemory(); // refresh memory on open
}                              
